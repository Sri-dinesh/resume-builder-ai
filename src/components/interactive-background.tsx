...
export default function InteractiveBackground() {
      ...
      colors:
        theme === "dark"
          ? {
              ...
              glowOrbs: ["rgba(125, 125, 255, 0.4)", "rgba(200, 100, 255, 0.3)", "rgba(90, 200, 255, 0.3)"],
          ...
          : {
              ...
              glowOrbs: ["rgba(100, 100, 255, 0.15)", "rgba(180, 80, 255, 0.1)", "rgba(70, 180, 255, 0.1)"],
  ...
  useEffect(() => {
    ...
    const glowOrbs = Array.from({ length: 5 }, () => ({
      ...
      color: config.colors.glowOrbs[Math.floor(Math.random() * config.colors.glowOrbs.length)],
    }))
  ...
  return (
    <>
      ...
      <div className="fixed top-1/4 left-1/4 w-96 h-96 rounded-full bg-primary/5 blur-3xl -z-10 animate-pulse-slow" />
      <div className="fixed bottom-1/4 right-1/4 w-96 h-96 rounded-full bg-violet-500/5 dark:bg-indigo-500/5 blur-3xl -z-10 animate-pulse-slow animation-delay-2000" />

      {/* Mouse follower effect */}
      {!reducedMotion && mousePosition.x > 0 && (
        <motion.div
          className="fixed pointer-events-none z-0 rounded-full bg-gradient-to-r from-primary/10 to-violet-500/10 dark:to-indigo-500/10 blur-3xl"
          animate={{
